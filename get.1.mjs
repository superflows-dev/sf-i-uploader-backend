import { KMS_KEY_REGISTER, ListObjectsV2Command, GetObjectCommand, GetObjectAttributesCommand, S3_BUCKET, S3_TEMP_FOLDER, PutObjectCommand, DeleteObjectCommand, s3Client, RECORD_TYPE_META, RECORD_TYPE_DATA, REGION, TABLE, AUTH_ENABLE, ddbClient, ScanCommand, PutItemCommand, getSignedUrl } from "./globals.mjs";
...
export const processGet1 = async (event) => {
    ...
    if (percentageComplete >= 100) {
        ...
        let fileKey = S3_TEMP_FOLDER + '/' + key + '.json';
        command = new PutObjectCommand({
            Bucket: S3_BUCKET,
            Key: fileKey,
            Body: JSON.stringify({data: blocks.join('')}),
        ...
        const response = { statusCode: 200, body: { result: true, ext: ext, signedUrlGet: signedUrlGet, signedUrlDelete: signedUrlDelete } };
